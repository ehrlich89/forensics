...
The SDK is specifically designed to interact with beacons that are enrolled in the Relution Beacon Management platform. E.g. you can use Relution to assign beacons a message which will be be discovered by SDK. At the moment the SDK supports iBeacon messages and custom Relution Tag messages. 
