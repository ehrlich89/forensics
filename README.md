...
The SDK is specifically designed to interact with the Relution Smart Beacon Management platform. The Relution Beacon Management System allows you to control and monitor a set of Smart Beacons. Relution e.g. makes it possible to assign each beacon a message that can be discovered by SDK. At the moment the SDK supports iBeacon messages and custom messages. 
