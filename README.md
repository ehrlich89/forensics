...
- The ```sdk``` package contains the SDK's source code. So, if you are interested in how the SDK components are implemented, you should have a closer look at these packages.
